...
subplot(4,1,1);
bar(Encounter_Year, [AnxietyMCounts AnxietyFCounts], 'grouped')
...
subplot(4,1,2);
bar(Encounter_Year, [DepressionMCounts DepressionFCounts], 'grouped')
title('Depression Encounters by Year by Gender');
xlabel('Year of Encounter Date')
ylabel('Count')

subplot(4,1,3);
bar(Encounter_Year, [SleepMCounts SleepFCounts], 'grouped')
title('Sleep Encounters by Year by Gender');
xlabel('Year of Encounter Date')
ylabel('Count')

subplot(4,1,4);
bar(Encounter_Year, [HeadacheMCounts HeadacheFCounts], 'grouped')
